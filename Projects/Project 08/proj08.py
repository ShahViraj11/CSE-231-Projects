...
def main(): 
    ...
    while choice != '5': 
        ...
        if choice == "1": #if choice being option 1
            ...
            max_names, max_val = find_max_common_friends(friends_dict) #calling the function that finds maximum common friends
            print("\nThe maximum number of commmon friends:", max_val)
            print("Pairs of non-friends with the most friends in common:") #printing out the values returned by the respective function
            for name in max_names:
                print(name) #printing out the name of respective function

        elif choice == "3":
            seconds_dict = find_second_friends(friends_dict)
            max_seconds, max_val = find_max_second_friends(seconds_dict) #calling out the function that fins maximum second friends
            print("\nThe maximum number of second-order friends:", max_val)
            print("People with the most second_order friends:") #printing out the values returned by the respective function
