...
#    entire description of planet is printed with the defined functions.
...
def main():  # main function
    ...
    for line in fp:
        ...
        if 0 < init_dist < newz:  # setting boundary for distance
            ...
            if temp_in_range(planet_axis, star_temp, star_radius, albedo, low_bound,
                             upp_bound):  # calling temperature function
                count2 += 1
    ...
    if count3 == 0:
        ...
        print("Closest rocky planet in the circumstellar habitable zone {} is {} light years away.".format(
            closestr.strip(),
            closest_distr))
    if count4 == 0:
        ...
        print(
            "Closest gaseous planet in the circumstellar habitable zone {} is {} light years away.".format(
                closestg.strip(),
                closest_distg))
    fp.close()
