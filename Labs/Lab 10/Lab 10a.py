...
last_card = player1_list[-1]
print()
print("Last card in hand of player #1: ",last_card)
last_card2 = player2_list[-1]
print("Last card in hand of player #2: ",last_card2)



print()
if last_card.rank() == last_card2.rank():
    print( last_card, "and", last_card2, "of equal rank" )
elif last_card.rank() > last_card2.rank():
    print(  last_card, "of higher rank than", last_card2 )
else:
    print( last_card2, "of higher rank than", last_card )
